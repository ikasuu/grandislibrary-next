    ...
    return (
      <ContentPage>
        ...
        <div className="repository-md-container">
          ...
          <p>You must complete the quest <a href="https://maplestorywiki.net/w/Quest/(Ramuramu)_Psych_Exam" target="_blank" rel="noreferrer noopener">"[Ramuramu] Psych Exam"</a> that consists of only a series of dialogue</p>
          <ul>
            <li>
                <strong>Normal Mode and Above Rewards: </strong>
