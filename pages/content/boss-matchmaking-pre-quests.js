    ...
    return (
      <ContentPage>
        ...
        <div className="repository-md-container">
          ...
          <h2 id="balrog"><img src="/images/map-icons/balrog.png" alt="MapIcon Balog"/> Balrog</h2>
          ...
          <div><Link smooth href="#top" scroll>Go to top</Link></div>
          <h2 id="zakum"><img src="/images/map-icons/zakum.png" alt="MapIcon Zakum"/> Zakum</h2>
          ...
          <div><Link smooth href="#top" scroll>Go to top</Link></div>
          <h2 id="ursus"><img src="/images/map-icons/ursus.png" alt="Soul Collector Artwork Ursus (1)"/> Ursus</h2>
          ...
          <div><Link smooth href="#top" scroll>Go to top</Link></div>
          <h2 id="magnus"><img src="/images/map-icons/magnus.png" alt="MapIcon Magnus"/> Magnus</h2>
          ...
          <div><Link smooth href="#top" scroll>Go to top</Link></div>
          <h2 id="hilla"><img src="/images/map-icons/hilla.png" alt="MapIcon Hilla"/> Hilla</h2>
          ...
          <div><Link smooth href="#top" scroll>Go to top</Link></div>
          <h2 id="omnicln"><img src="/images/map-icons/omega-sector.png" alt="MapIcon OmegaSector"/> OMNI-CLN</h2>
          ...
          <ul>
            <li>
                <strong>Main Rewards: </strong>[Elixir], <img src="/images/items/rebirth-flame-110.png" alt="Use Rebirth Flame Lv. 110"/> [Lv. 110 Rebirth Flame], <img src="/images/items/omni-cln-component.png" alt="Etc OMNI-CLN Component"/> <a href="https://maplestory.fandom.com/wiki/OMNI-CLN_Component" target="_blank" rel="noreferrer noopener">[OMNI-CLN Component]</a>, <img src="/images/items/occult-cube.png" alt="Use Occult Cube"/> [Occult Cube], <img src="/images/items/intense-power-crystal.png" alt="Etc Intense Power Crystal"/> [Intense Power Crystal], <img src="/images/items/crusader-coin.png" alt="Etc Crusader Coins"/> [Crusader Coins]
            </li>
          ...
          <div><Link smooth href="#top" scroll>Go to top</Link></div>
          <h2 id="papulatus"><img src="/images/map-icons/ludibrium.png" alt="MapIcon Papulatus Clock"/> Papulatus</h2>
          ...
          <div><Link smooth href="#top" scroll>Go to top</Link></div>
          <h2 id="rootabyss"><img src="/images/map-icons/pierre.png" alt="MapIcon Piere"/><img src="/images/map-icons/von-bon.png" alt="MapIcon BanBan"/><img src="/images/map-icons/crimson-queen.png" alt="MapIcon BloodyQueen"/><img src="/images/map-icons/vellum.png" alt="MapIcon Bellum"/> Root Abyss</h2>
          ...
          <ul>
            ...
            <li>
                ...
                <img src="/images/equipment/pierre-hat.png" alt="Eqp Pierre Hat"/>
                <img src="/images/equipment/von-bon-helmet.png" alt="Eqp Von Bon Helmet"/>
                <img src="/images/equipment/vellums-helm.png" alt="Eqp Vellum's Helm"/> [Chaos Hat], <img src=" /images/items/power-elixir.png" alt="Use Power Elixir"/> [Power Elixir], <img src="https://maplestory.io/api/GMS/210.1.1/item/2434586/icon" alt=""/><img src="https://maplestory.io/api/GMS/210.1.1/item/2434585/icon" alt=""/><img src="https://maplestory.io/api/GMS/210.1.1/item/2434584/icon" alt=""/>
                <img src="https://maplestory.io/api/GMS/210.1.1/item/2434587/icon" alt=""/> [Chaos Root Abyss Gear Fragment]
                <img src="/images/items/rebirth-flame-150.png" alt="Use Rebirth Flame Lv. 150"/> [Lv. 150 Rebirth Flame], <img src=" /images/items/chaos-yggdrasil-rune.png" alt="Etc Chaos Yggdrasil Rune"/> [Chaos Yggdrasil Coin]
              </li>
              <li><strong>Can clear Chaos</strong>: Weekly</li>
              <li><strong>Location</strong>: <a href="https://maplestory.wiki/GMS/210.1.1/map/105200000">Root Abyss: Colossal Root</a> in Sleepywood, accessible from Dimensonal Mirror</li>
          </ul>
          <div><Link smooth href="#top" scroll>Go to top</Link></div>
          <h2 id="vonleon"><img src="/images/map-icons/von-leon.png" alt="MapIcon VanLeon"/> Von Leon</h2>
          ...
          <div><Link smooth href="#top" scroll>Go to top</Link></div>
          <h2 id="horntail"><img src="/images/map-icons/horntail.png" alt="MapIcon Hontale"/> Horntail</h2>
          ...
          <ul>
            <li>
                <strong>Easy Mode and Above Rewards: </strong><a href="https://maplestory.wiki/GMS/210.1.1/item/1113149" target="_blank" rel="noreferrer noopener">[Silver Blossom Ring]</a>, <img src="/images/equipment/dea-sidus-earrings.png" alt="Eqp Dea Sidus Earring"/>
                <a href="https://maplestory.wiki/GMS/210.1.1/item/1032241" target="_blank" rel="noreferrer noopener">[Dea Sidus Earrings]</a>, <img src="/images/equipment/horntail-necklace.png" alt="Eqp Horntail Necklace"/>
                <a href="https://maplestory.wiki/GMS/210.1.1/item/1122000" target="_blank" rel="noreferrer noopener">[Horntail Necklace]</a>, <img src="/images/equipment/muspell-warrior-hat.png" alt="Eqp Muspell Warrior Hat"/> [Lv. 130 Gear], <img src="/images/items/elixir.png" alt="Use Elixir"/> [Elixir], <img src="/images/items/rebirth-flame-120.png" alt="Use Rebirth Flame Lv. 120"/> [Lv. 120 Rebirth Flame], <img src="/images/items/occult-cube.png" alt="Use Occult Cube"/> [Occult Cube], <img src="/images/items/master-craftsmans-cube.png" alt="Use Master Craftsman's Cube"/> [Master Craftsman's
                Cube], <img src="/images/items/intense-power-crystal.png" alt="Etc Intense Power Crystal"/> [Intense Power Crystal], <img src="/images/items/crusader-coin.png" alt="Etc Crusader Coins"/> [Crusader Coins]
            </li>
            <li>
                <strong>Normal/Chaos Mode Only Rewards:</strong>
                <img src="/images/equipment/pensalir-battle-helm.png" alt="Eqp Pensalir Battle Helm"/> [Lv. 140 Gear], <img src="/images/equipment/chaos-horntail-necklace.png" alt="Eqp Chaos Horntail Necklace"/>
                <a href="https://maplestory.wiki/GMS/210.1.1/item/1122076" target="_blank" rel="noreferrer noopener">[(Chaos Only) Chaos Horntail Necklace]</a>, <img src=" /images/items/power-elixir.png" alt="Use Power Elixir"/> [<em>(Chaos Only)</em> Power Elixir]
            </li>
            <li><strong>Can clear</strong>: Daily</li>
          ...
          <div><Link smooth href="#top" scroll>Go to top</Link></div>
          <h2 id="arkarium"><img src="/images/map-icons/arkarium.png" alt="MapIcon Akairum"/> Arkarium</h2>
          ...
          <ul>
            <li>
                <strong>Easy mode and Above Rewards: </strong>[Lv. 130 Gear], <img src=" /images/equipment/mechanator-pendant.png" alt="Eqp Mechanator Pendant"/>
                <a href="https://maplestory.fandom.com/wiki/Mechanator_Pendant" target="_blank" rel="noreferrer noopener">[Mechanator Pendant]</a>, <img src="/images/items/elixir.png" alt="Use Elixir"/> [Elixir], <img src="/images/items/rebirth-flame-130.png" alt="Use Rebirth Flame Lv. 130"/> [Rebirth Flame], <img src="/images/items/soul-shard.png" alt="Use Soul Shard"/> [Soul Shard], <img src=" /images/items/primal-essence.png" alt="Etc Primal Essence"/>
                <a href="https://maplestory.fandom.com/wiki/Primal_Essence" target="_blank" rel="noreferrer noopener">[Primal Essence]</a>, <img src="/images/items/occult-cube.png" alt="Use Occult Cube"/> [Occult Cube], <img src="/images/items/master-craftsmans-cube.png" alt="Use Master Craftsman's Cube"/> [Master Craftsman's
                Cube],<img src="/images/items/intense-power-crystal.png" alt="Etc Intense Power Crystal"/> [Intense Power Crystal], <img src="/images/items/crusader-coin.png" alt="Etc Crusader Coins"/> [Crusader Coin]
            </li>
            <li>
                <strong>Normal mode only Rewards: </strong>[Lv. 140 Gear], <img src=" /images/equipment/dominator-pendant.png" alt="Eqp Dominator Pendant"/>
                <a href="https://maplestory.fandom.com/wiki/Dominator_Pendant" target="_blank" rel="noreferrer noopener">[Dominator Pendant]</a>, <img src=" /images/items/power-elixir.png" alt="Use Power Elixir"/> [Power Elixir]
            </li>
            <li><strong>Can clear</strong>: Daily</li>
          ...
          <div><Link smooth href="#top" scroll>Go to top</Link></div>
          <h2 id="pinkbean"><img src="/images/map-icons/pink-bean-boss.png" alt="MapIcon PinkBean"/> Pink Bean</h2>
          ...
          <div><Link smooth href="#top" scroll>Go to top</Link></div>
          <h2 id="cygnus"><img src="/images/map-icons/cygnus-boss.png" alt="MapIcon Signus"/> Cygnus</h2>
          ...
          <ul>
            <li>
                <strong>Easy Mode and Above Rewards: </strong>[Lv. 140 Gear], <img src=" /images/items/power-elixir.png" alt="Use Power Elixir"/> [Power Elixir], <img src="/images/items/rebirth-flame-140.png" alt="Use Rebirth Flame Lv. 140"/> [Rebirth Flame], <img src="/images/items/soul-shard.png" alt="Use Soul Shard"/> [Soul Shard], <img src=" /images/items/piece-of-ruin.png" alt="Use Piece of Ruin"/>
                <img src=" /images/items/piece-of-darkness.png" alt="Use Piece of Darkness"/> [Empress Gear Fragment], <img src="/images/items/occult-cube.png" alt="Use Occult Cube"/> [Occult Cube], <img src="/images/items/master-craftsmans-cube.png" alt="Use Master Craftsman's Cube"/> [Master Craftsman's
                Cube], <img src="/images/items/intense-power-crystal.png" alt="Etc Intense Power Crystal"/> [Intense Power Crystal]
            </li>
            <li>
                <strong>Normal Mode only Rewards:</strong>
                <img src="/images/equipment/lionheart-battle-shoulder.png" alt="Eqp Lionheart Battle Shoulder"/>
                <a href="https://maplestory.fandom.com/wiki/Equipment_Set/Lionheart_Set" target="_blank" rel="noreferrer noopener">[Empress Shoulder]</a>, <img src=" /images/equipment/deimos-warrior-shield.png" alt="Eqp Deimos Sage Shield"/>
                <img src=" /images/equipment/deimos-shadow-shield.png" alt="Eqp Deimos Shadow Shield"/>
                <img src=" /images/equipment/deimos-sage-shield.png" alt="Eqp Deimos Warrior Shield"/> [Shield Recipes]
            </li>
          ...
          <div><Link smooth href="#top" scroll>Go to top</Link></div>
          <h2 id="lotus"><img src="/images/map-icons/haven.png" alt="MapIcon Haven"/> Lotus</h2>
          ...
          <ul>
            <li>
                <strong>Normal Mode and Above Rewards: </strong><img src=" /images/items/power-elixir.png" alt="Use Power Elixir"/> [Power
                Elixir], <img src="/images/items/rebirth-flame-150.png" alt="Use Rebirth Flame Lv. 150"/> [Rebirth Flame], <img src="/images/items/soul-shard.png" alt="Use Soul Shard"/> [Soul Shard], <img src="/images/items/occult-cube.png" alt="Use Occult Cube"/> [Occult Cube], <img src="/images/items/extraordinary-energy-core.png" alt="Etc Extraordinary Energy Core (Grade S)"/>
                [Extraordinary Energy Core (Grade S)], <img src="/images/items/intense-power-crystal.png" alt="Etc Intense Power Crystal"/> [Intense Power Crystal], <img src="/images/items/crusader-coin.png" alt="Etc Crusader Coins"/> [Crusader Coins]
            </li>
            <li>
                <strong>Hard Mode Only Rewards: </strong>
          ...
          <div><Link smooth href="#top" scroll>Go to top</Link></div>
          <h2 id="damien"><img src="/images/map-icons/dark-world-tree.png" alt="MapIcon fallenWorldTree"/> Damien</h2>
          <p><strong>[Normal/Hard Lv. 190+]</strong></p>
          ...
          <ul>
            <li>
                <strong>Normal Mode and Above Rewards: </strong><img src="/images/equipment/ruin-force-shield.png" alt="Eqp Ruin Force Shield"/>
                <a href="https://maplestory.wiki/GMS/210.1.1/item/1099015" target="_blank" rel="noreferrer noopener">[(Demon-Class Exclusive) Ruin Force Shield]</a>, <img src=" /images/items/power-elixir.png" alt="Use Power Elixir"/> [Power Elixir], <img src="/images/items/rebirth-flame-150.png" alt="Use Rebirth Flame Lv. 150"/> [Rebirth Flame], <img src="/images/items/soul-shard.png" alt="Use Soul Shard"/> [Soul Shard], <img src="/images/items/occult-cube.png" alt="Use Occult Cube"/> [Occult Cube], <img src="/images/items/twisted-stigma-spirit-stone.png" alt="Etc Twisted Stigma Spirit Stone"/> [Twisted Stigma
                Spirit Stone], <img src="/images/items/intense-power-crystal.png" alt="Etc Intense Power Crystal"/> [Intense Power Crystal], <img src="/images/items/crusader-coin.png" alt="Etc Crusader Coins"/> [Crusader Coins]
            </li>
            <li>
          ...
          <div><Link smooth href="#top" scroll>Go to top</Link></div>
          <h2 id="lucid"><img src="/images/map-icons/lachelein.png" alt="MapIcon Lacheln"/> Lucid</h2>
          ...
          <ul>
            <li>
                <strong>Easy Mode and Above Rewards:</strong> <img src=" /images/items/power-elixir.png" alt="Use Power Elixir"/> [Power
                Elixir], <img src="/images/items/rebirth-flame-150.png" alt="Use Rebirth Flame Lv. 150"/> [Lv. 150 Rebirth
                Flame], <img src="/images/items/soul-shard.png" alt="Use Soul Shard"/> [Soul Shard], <img src="/images/items/occult-cube.png" alt="Use Occult Cube"/> [Occult Cube], <img src="/images/items/bonus-occult-cube.png" alt="Use Bonus Occult Cube"/> [Bonus Occult Cube], <img src="/images/items/intense-power-crystal.png" alt="Etc Intense Power Crystal"/> [Intense Power Crystal], <img src="/images/items/crusader-coin.png" alt="Etc Crusader Coins"/> [Crusader Coins]
            </li>
            ...
            <li>
                <strong>Hard Mode Only Rewards: </strong><a href="https://maplestory.fandom.com/wiki/Lucidroid" target="_blank" rel="noreferrer noopener">[Lucidroid]</a>, <img src="/images/equipment/dreamy-belt.png" alt="Eqp Dreamy Belt"/>
                <a href="https://maplestory.wiki/GMS/210.1.1/item/1132308" target="_blank" rel="noreferrer noopener">[Dreamy Belt]</a>, <img src="/images/equipment/arcane-umbra-knight-shoes.png" alt="Eqp Arcane Umbra Knight Shoes"/>
                <img src="/images/equipment/arcane-umbra-knight-gloves.png" alt="Eqp Arcane Umbra Knight Gloves"/>
                <img src="/images/equipment/arcane-umbra-saber.png" alt="Eqp Arcane Umbra Saber"/>
          ...
          <div><Link smooth href="#top" scroll>Go to top</Link></div>
          <h2 id="gollux"><img src="/images/map-icons/gollux.png" alt="MapIcon GiantVellud"/> Gollux</h2>
          ...
          <ul>
            <li>
                <strong>Main Rewards:</strong> <img src="/images/items/gollux-penny.png" alt="Etc Gollux Penny"/>
                <img src="/images/items/gollux-coin.png" alt="Etc Gollux Coin"/> [Gollux Penny/Coins], <img src="/images/equipment/superior-gollux-earrings.png" alt="Eqp Superior Gollux Earrings"/>
                <img src="/images/equipment/superior-gollux-ring.png" alt="Eqp Superior Gollux Ring"/>
          ...
          <div><Link smooth href="#top" scroll>Go to top</Link></div>
          <h2 id="gloom"><img src="/images/map-icons/moonbridge.png" alt="MapIcon moonBridge"/> Gloom</h2>
          ...
          <div><Link smooth href="#top" scroll>Go to top</Link></div>
          <h2 id="verushilla"><img src="/images/map-icons/labyrinth-of-suffering.png" alt="MapIcon TheLabyrinthOfSuffering"/> Verus Hilla</h2>
          ...
          <ul>
            <li>
                ...
                <img src="/images/equipment/source-of-suffering.png" alt="Eqp Source of Suffering"/>
                <a href="https://maplestory.wiki/GMS/210.1.1/item/1122430" target="_blank" rel="noreferrer noopener">[Source of Suffering]</a>, <img src=" /images/items/power-elixir.png" alt="Use Power Elixir"/> [Power Elixir], <img src="/images/items/rebirth-flame-150.png" alt="Use Rebirth Flame Lv. 150"/> [Lv. 150 Rebirth Flame], <img src="/images/items/soul-shard.png" alt="Use Soul Shard"/> [Soul Shard], <img src="/images/items/occult-cube.png" alt="Use Occult Cube"/> [Occult Cube], <img src="/images/items/intense-power-crystal.png" alt="Etc Intense Power Crystal"/> [Intense Power Crystal], <img src="/images/items/shadow-of-annihilation.png" alt="Etc Shadow of Annihilation"/>
          ...
          <div><Link smooth href="#top" scroll>Go to top</Link></div>
          <h2 id="darknell"><img src="/images/map-icons/limina.png" alt="MapIcon Limen"/> Darknell</h2>
          ...
          <div><Link smooth href="#top" scroll>Go to top</Link></div>
          <h2 id="blackmage"><img src="/images/map-icons/limina.png" alt="MapIcon Limen"/> Black Mage</h2>
          ...
          <ul>
            <li>
                ...
                <a href="https://maplestory.fandom.com/wiki/Sealed_Genesis_Weapon_Box" target="_blank" rel="noreferrer noopener">[Sealed Genesis Weapon Box]</a>, <img src="/images/equipment/genesis-badge.png" alt="Eqp Genesis Badge"/>
                <a href="https://maplestory.wiki/GMS/210.1.1/item/1182285" target="_blank" rel="noreferrer noopener">[Genesis Badge]</a>, <img src=" /images/items/power-elixir.png" alt="Use Power Elixir"/> [Power Elixir], <img src="/images/items/rebirth-flame-150.png" alt="Use Rebirth Flame Lv. 150"/> [Lv. 150 Rebirth Flame], <img src="/images/items/occult-cube.png" alt="Use Occult Cube"/> [Occult Cube], <img src="/images/items/intense-power-crystal.png" alt="Etc Intense Power Crystal"/> [Intense Power Crystal], <img src="/images/items/crusader-coin.png" alt="Etc Crusader Coins"/> [Crusader Coins]
            </li>
          ...
          <div><Link smooth href="#top" scroll>Go to top</Link></div>
          <h2 id="ranmaru"><img src="/images/map-icons/ranmaru.png" alt="MapIcon Ranmaru"/> Ranmaru</h2>
          ...
          <ul>
              <li>
                  ...
                  <a href="https://maplestory.fandom.com/wiki/Eternal_Rebirth_Flame" target="_blank" rel="noreferrer noopener">[Special Rebirth Flames]</a>, <img src="/images/items/occult-cube.png" alt="Use Occult Cube"/> [Occult Cube], <img src="/images/items/master-craftsmans-cube.png" alt="Use Master Craftsman's Cube"/> [Master Craftsman's
                  Cube], <img src="/images/items/intense-power-crystal.png" alt="Etc Intense Power Crystal"/> [Intense Power Crystal]
              </li>
              <li>
          ...
          <div><Link smooth href="#top" scroll>Go to top</Link></div>
          <h2 id="princessno"><img src="/images/map-icons/princess-no-boss.png" alt="MapIcon JP Nohime"/> Princess No</h2>
          ...
          <div><Link smooth href="#top" scroll>Go to top</Link></div>
          <h2 id="will"><img src="/images/map-icons/esfera.png" alt="MapIcon esfera"/> Will</h2>
          ...
          <ul>
            <li>
                <strong>Normal Mode and Above Rewards: </strong>[Power Elixir], <img src="/images/items/rebirth-flame-150.png" alt="Use Rebirth Flame Lv. 150"/> [Lv. 150 Rebirth Flame], <img src="/images/items/soul-shard.png" alt="Use Soul Shard"/> [Soul Shard], <img src="/images/items/occult-cube.png" alt="Use Occult Cube"/> [Occult Cube], <img src="/images/items/stone-cobweb-droplet.png" alt="Etc Stone Cobweb Droplet"/> [Stone Cobweb Droplet], <img src="/images/items/intense-power-crystal.png" alt="Etc Intense Power Crystal"/> [Intense Power Crystal], <img src="/images/items/crusader-coin.png" alt="Etc Crusader Coins"/> [Crusader Coins]
            </li>
            <li>
                <strong>Hard Mode Only Rewards: </strong>
                <img src="/images/equipment/cursed-red-spellbook.png" alt="Eqp Cursed Red Spellbook"/>
                <img src="/images/equipment/cursed-blue-spellbook.png" alt="Eqp Cursed Blue Spellbook"/>
                <img src="/images/equipment/cursed-green-spellbook.png" alt="Eqp Cursed Green Spellbook"/>
                <img src="/images/equipment/cursed-yellow-spellbook.png" alt="Eqp Cursed Yellow Spellbook"/>
                <a href="https://maplestory.wiki/GMS/210.1.1/item/1162080" target="_blank" rel="noreferrer noopener">[Cursed Spellbook]</a>, <img src="/images/equipment/arcane-umbra-knight-hat.png" alt="Eqp Arcane Umbra Knight Hat"/>
                <img src="https://maplestory.wiki/GMS/220/item/1152196" alt="Eqp Arcane Umbra Knight Shoulder"/>
                <img src="/images/equipment/arcane-umbra-knight-suit.png" alt="Eqp Arcane Umbra Knight Suit"/>
                <img src="/images/equipment/arcane-umbra-saber.png" alt="Eqp Arcane Umbra Saber"/>
                <a href="https://maplestory.fandom.com/wiki/Equipment_Set/Arcane_Umbra_Set_(Warrior)" target="_blank" rel="noreferrer noopener">[(Hat/Shoulder/Overall/Weapon) Arcane Umbra Gear]</a>, <img src="/images/items/mirror-world-nodestone.png" alt="Use Mirror World Nodestone"/>
          ...
          <div><Link smooth href="#top" scroll>Go to top</Link></div>
          <h2 id="julieta"><img src="/images/map-icons/abrup.png" alt="MapIcon PL Abrup"/> Julieta</h2>
