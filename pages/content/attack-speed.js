...
function AttackSpeed() {
    return (
        <ContentPage>
            ...
            <p><strong>[Note]: </strong>All mages except Battle Mage are not affected by their weapon's Attack Speed. Instead, all attacks have a cast speed of Normal (Stage 4) regardless of weapon which is still affected by Attack Speed</p>
            <VideoAd/>
            <h2>Savior Update Change</h2>
            <p>Prior to the Savior Update, Attack Speed referred to AS0 as the fastest and AS9 as the slowest. After the Savior Update, Stage 10 is the fastest and Stage 1 is the slowest. For applicable regions, Stage 8 (AS2) is the Soft Cap and Stage 10 (AS0) is the Hard Cap.</p>
            ...
            <ul>
                ...
                <li>Axe [1H] (Fast 5)
                    <ul>
                        <li>Sweetwater Axe is (Normal 4)</li>
                    </ul>
                </li>
                <li>Blunt Weapon [1H] (Fast 5)
                    <ul>
                        <li>Sweetwater Mace is (Normal 4)</li>
                    </ul>
                </li>
                <li>Soul Shooter [1H] (Fast 5)
                    <ul>
                        <li>Sweetwater is (Normal 4)</li>
                    </ul>
                </li>
            ...
            <h3>Normal (4)</h3>
            <ul>
                <li>Wand [1H] (Normal 4)</li>
                <li>Shining Rod [1H] (Normal 4)</li>
                <li>Sword [2H] (Normal 4)</li>
                <li>Axe [2H] (Normal 4)</li>
                <li>Blunt Weapon [2H] (Normal 4)</li>
                <li>Spear [2H] (Normal 4)</li>
                <li>Bow [2H] (Normal 4)</li>
                <li>Crossbow [2H] (Normal 4)</li>
                <li>Dual Bowguns [2H] (Normal 4)</li>
                <li>Desperado [1H] (Normal 4)</li>
                <li>Scepter [1H] (Normal 4)</li>
                <li>Psy-limiter [1H] (Normal 4)</li>
                <li>Alpha Long Sword [1H] (Normal 4)</li>
                <li>Lucent Gauntlet [1H] (Normal 4)</li>
                <li>Ancient Bow [1H] (Normal 4)</li>
            </ul>
            <h3>Slow (8)</h3>
            <ul>
                <li>Staff [1H] (Slow 2)
                    <ul>
                        ...
                        <li>ACS Staff and Genesis is (Normal 4)</li>
                    </ul>
                </li>
                <li>Hand Cannon [2H] (Slow 2)</li>
                <li>Kanna Fan [2H] (Slow 2)
                    <ul>
                        <li>ACS and Genesis is (Normal 4)</li>
                    </ul>
                </li>
            ...
            <h3>Examples:</h3>
            <p>A Dark Knight wielding a <img src="/images/equipment/fafnir-brionak.png" alt="Eqp Fafnir Brionak"/> Fafnir Brionak, which is Normal (4). The Dark Knight uses their <img src="/class-icons/explorers/dark-knight/weapon-booster.png" alt="Skill Weapon Booster (Spearman)"/> Weapon Booster skill that gives +2 AS, plus they have <img src="/class-icons/common/speed-infusion.png" alt="Skill Speed Infusion"/> Decent Speed Infusion that gives +1 AS (for a total of +3 AS). Thus, their final attack speed is: Normal (4) + (+3 AS) = Faster (7)</p>
            <p>A Cannoneer with a <img src="/images/equipment/fafnir-lost-cannon.png" alt="Eqp Fafnir Lost Cannon"/> Fafnir Lost Cannon, which is Slow (2). The Cannoneer gets +2 AS from their <img src="/class-icons/explorers/cannoneer/cannon-booster.png" alt="Skill Cannon Booster"/> Weapon Booster skill, +1 AS from the <img src="/class-icons/explorers/cannoneer/reinforced-cannon.png" alt="Skill Reinforced Cannon"/> Reinforced Cannon skill, +1 AS from the <img src="/class-icons/explorers/cannoneer/cannon-overload.png" alt="Skill Cannon Overload"/> Cannon Overload skill, +1 AS from the <img src="/images/items/extreme-green-potion.png" alt="Use Extreme Green Potion"/> Extreme Green Potion (for a total of +5 AS). Thus, their final attack speed is: Slow (2) + (+5 AS) = Faster (7)</p>
            ...
            <h3>Example:</h3>
            <p>A Shadower with a <img src="/images/equipment/fafnir-damascus.png" alt="Eqp Fafnir Damascus"/> Fafnir Damascus, which is Fast (6). The Shadower gets +2 AS from their <img src="/class-icons/explorers/shadower/dagger-booster.png" alt="Skill Dagger Booster"/> Weapon Booster skill. They also have +1 AS Inner Ability. You may think her final attack speed is Fastest (1), since Fast (6) + (+3 AS) = Fastest (9). However, their weapon boosting skill nor the +1 attack speed inner ability can break the soft speed cap of Fastest (8). Thus, they are stuck at Fastest (8) despite their inner ability</p>
