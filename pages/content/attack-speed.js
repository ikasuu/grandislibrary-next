...
function AttackSpeed() {
    return (
        <ContentPage>
            ...
            <p><strong>[Note]: </strong>Hurricane-type / Key-down skills like <img src="/class-icons/explorers/bowmaster/hurricane.png" alt="Skill Hurricane" width="32" height="32"/> <a href="https://maplestory.fandom.com/wiki/Hurricane" target="_blank" rel="noreferrer noopener">Hurricane</a>, <img src="/class-icons/heroes/phantom/mille-aiguilles.png" alt="Skill Mille Aiguilles" width="32" height="32"/> <a href="https://maplestory.fandom.com/wiki/Mille_Aiguilles" target="_blank" rel="noreferrer noopener">Mille Aiguilles</a>, <img src="/class-icons/heroes/mercedes/ishtars-ring.png" alt="Skill Ishtar's Ring" width="32" height="32"/> <a href="https://maplestory.fandom.com/wiki/Ishtar's_Ring" target="_blank" rel="noreferrer noopener">Ishtar's Ring</a>, <img src="/class-icons/resistance/xenon/beam-dance.png" alt="Skill Beam Dance" width="32" height="32"/> <a href="https://maplestory.fandom.com/wiki/Beam_Dance" target="_blank" rel="noreferrer noopener">Beam Dance</a>, or <img src="/class-icons/resistance/wild-hunter/wild-arrow-blast.png" alt="Skill Wild Arrow Blast"/> <a href="https://maplestory.fandom.com/wiki/Wild_Arrow_Blast" target="_blank" rel="noreferrer noopener">Wild Arrow Blast</a> are not affected by Attack Speed</p>
            ...
            <p>All classes have a standard <img src="/class-icons/heroes/aran/polearm-booster.png" alt="Skill Polearm Booster" width="32" height="32"/> <img src="/class-icons/heroes/evan/magic-booster.png" alt="Skill Magic Booster (Evan)" width="32" height="32"/> Weapon Booster skill that increases your attack speed by +2 stages</p>
            <p>A few classes have skills other than their typical weapon boosting skill that further that boosts their attack speed (i.e. Buccaneer or Thunder Breaker's <img src="/class-icons/common/speed-infusion.png" alt="Skill Speed Infusion" width="32" height="32"/> <a href="https://maplestory.fandom.com/wiki/Speed_Infusion" target="_blank" rel="noreferrer noopener">Speed Infusion</a> provides another +2 AS, a Kaiser using <img src="/class-icons/nova/kaiser/dragon-link.png" alt="Skill Dragon Link" width="32" height="32"/> key-command skills when their Dragon Gauge is filled provides another +2 AS, etc.)</p>
            <p>As well, there are sources beyond your class's skills that you can obtain to further increase your Attack Speed (i.e. +1 AS Inner Ability +1 AS from <img src="/class-icons/common/speed-infusion.png" alt="Skill Speed Infusion" width="32" height="32"/> <a href="https://maplestory.fandom.com/wiki/Decent_Speed_Infusion" target="_blank" rel="noreferrer noopener">Decent Speed Infusion</a>, +1 AS from <img src="/images/items/extreme-green-potion.png" alt="Use Extreme Green Potion" width="22" height="31"/> <a href="https://maplestory.fandom.com/wiki/Extreme_Green_Potion" target="_blank" rel="noreferrer noopener">Extreme Green Potion</a> from Monster Park, etc.)</p>
            ...
            <h3>Examples:</h3>
            <p>A Dark Knight wielding a <img src="https://maplestory.io/api/GMS/210.1.1/item/1432167/icon" alt=""/> Fafnir Brionak, which is Normal (6). The Dark Knight uses their <img src="/class-icons/explorers/dark-knight/weapon-booster.png" alt="Skill Weapon Booster (Spearman)" width="32" height="32"/> Weapon Booster skill that gives +2 AS, plus they have <img src="/class-icons/common/speed-infusion.png" alt="Skill Speed Infusion" width="32" height="32"/> Decent Speed Infusion that gives +1 AS (for a total of +3 AS). Thus, their final attack speed is: Normal (6) - (+3 AS) = Faster (3)</p>
            <p>A Cannoneer with a <img src="https://maplestory.io/api/GMS/210.1.1/item/1532098/icon" alt=""/> Fafnir Lost Cannon, which is Slow (8). The Cannoneer gets +2 AS from their <img src="/class-icons/explorers/cannoneer/cannon-booster.png" alt="Skill Cannon Booster" width="32" height="32"/> Weapon Booster skill, +1 AS from the <img src="/class-icons/explorers/cannoneer/reinforced-cannon.png" alt="Skill Reinforced Cannon" width="32" height="32"/> Reinforced Cannon skill, +1 AS from the <img src="/class-icons/explorers/cannoneer/cannon-overload.png" alt="Skill Cannon Overload" width="32" height="32"/> Cannon Overload skill, +1 AS from the <img src="https://maplestory.io/api/GMS/210.1.1/item/2023126/icon" alt=""/> Extreme Green Potion (for a total of +5 AS). Thus, their final attack speed is: Slow (8) - (+5 AS) = Faster (3)</p>
            ...
            <h3>Example:</h3>
            <p>A Shadower with a <img src="https://maplestory.io/api/GMS/210.1.1/item/1332225/icon" alt=""/> Fafnir Damascus, which is Fast (4). The Shadower gets +2 AS from their <img src="/class-icons/explorers/shadower/dagger-booster.png" alt="Skill Dagger Booster" width="32" height="32"/> Weapon Booster skill. They also have +1 AS Inner Ability. You may think her final attack speed is Fastest (1), since Fast (4) - (+3 AS) = Fastest (1). However, their weapon boosting skill nor the +1 attack speed inner ability can break the soft speed cap of Fastest (2). Thus, they are stuck at Fastest (2) despite her inner ability</p>
            ...
            <h3>Example:</h3>
            <p>An Aran with the <img src="https://maplestory.io/api/GMS/210.1.1/item/1442002/icon" alt=""/> Eviscerator polearm, which is Slower (9). The Aran gets +2 AS from their <img src="/class-icons/heroes/aran/polearm-booster.png" alt="Skill Polearm Booster" width="32" height="32"/> Weapon Booster skill, +1 AS from <img src="/class-icons/heroes/aran/polearm-mastery.png" alt="Skill Polearm Mastery" width="32" height="32"/> Polearm Mastery skill, +1 AS from <img src="/class-icons/common/speed-infusion.png" alt="Skill Speed Infusion" width="32" height="32"/> Decent Speed Infusion, +1 from Inner Ability, and +1 from <img src="/images/items/extreme-green-potion.png" alt="Use Extreme Green Potion" width="22" height="31"/> Extreme Green Potion (for a total of +6 AS). Thus, their attack speed would be: Slower (9) - (+6 AS) = Fastest (3)</p>
