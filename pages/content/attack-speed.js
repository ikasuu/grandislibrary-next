...
function AttackSpeed() {
    return (
        <ContentPage>
            ...
            <p>An example of this is the Lv. 80 <img src="https://maplestory.io/api/GMS/210.1.1/item/1442019/icon" alt=""/> Eclipse polearm weapon. Like most other polearms, it is labeled as a Slow speed weapon, but those who have used this weapon can tell that the Eclipse polearm attacks faster than other Slow speed polearms. Thus, the Eclipse polearm is designated as Slow (7), while other Slow speed polearms are labeled Slow (8)</p>
            <ul>
                <li>Fastest (0)</li>
                <li>Fastest (1)</li>
                <li>Fastest (2)</li>
            </ul>
            <p>There are no weapons that naturally have above Fastest (3) attack speed values</p>
            <p><strong>[Note]: </strong>Hurricane-type / Key-down skills like <img src="https://vignette.wikia.nocookie.net/maplestory/images/1/18/Skill_Hurricane.png/revision/latest?cb=20110502142405" alt="Skill Hurricane" width="32" height="32"/> <a href="https://maplestory.fandom.com/wiki/Hurricane" target="_blank" rel="noreferrer noopener">Hurricane</a>, <img src="https://vignette.wikia.nocookie.net/maplestory/images/a/a2/Skill_Mille_Aiguilles.png/revision/latest?cb=20111226182135" alt="Skill Mille Aiguilles" width="32" height="32"/> <a href="https://maplestory.fandom.com/wiki/Mille_Aiguilles" target="_blank" rel="noreferrer noopener">Mille Aiguilles</a>, <img src="https://vignette.wikia.nocookie.net/maplestory/images/7/70/Skill_Ishtar%27s_Ring.png/revision/latest?cb=20110810053956" alt="Skill Ishtar's Ring" width="32" height="32"/> <a href="https://maplestory.fandom.com/wiki/Ishtar's_Ring" target="_blank" rel="noreferrer noopener">Ishtar's Ring</a>, <img src="https://vignette.wikia.nocookie.net/maplestory/images/6/60/Skill_Beam_Dance.png/revision/latest?cb=20121217234717" alt="Skill Beam Dance" width="32" height="32"/> <a href="https://maplestory.fandom.com/wiki/Beam_Dance" target="_blank" rel="noreferrer noopener">Beam Dance</a>, or <img src="https://vignette.wikia.nocookie.net/maplestory/images/7/71/Skill_Wild_Arrow_Blast.png/revision/latest?cb=20110515144423" alt="Skill Wild Arrow Blast"/> <a href="https://maplestory.fandom.com/wiki/Wild_Arrow_Blast" target="_blank" rel="noreferrer noopener">Wild Arrow Blast</a> are not affected by Attack Speed</p>
            ...
            <p>All classes have a standard <img src="https://vignette.wikia.nocookie.net/maplestory/images/4/48/Skill_Polearm_Booster.png/revision/latest?cb=20100603074001" alt="Skill Polearm Booster" width="32" height="32"/> <img src="https://vignette.wikia.nocookie.net/maplestory/images/e/e4/Skill_Magic_Booster_%28Evan%29.png/revision/latest?cb=20100531000939" alt="Skill Magic Booster (Evan)" width="32" height="32"/> Weapon Booster skill. Most Booster skills increase your attack speed by +2 stages, but some only increases by +1 stage (i.e. <img src="https://vignette.wikia.nocookie.net/maplestory/images/b/b6/Skill_Melody_Cross.png/revision/latest?cb=20120731153256" alt="Skill Melody Cross" width="32" height="32"/> Angelic Buster's <a href="https://maplestory.fandom.com/wiki/Melody_Cross" target="_blank" rel="noreferrer noopener">Melody Cross</a>)</p>
            <p>A few classes have skills other than their typical weapon boosting skill that further that boosts their attack speed (i.e. Buccaneer or Thunder Breaker's <img src="https://vignette.wikia.nocookie.net/maplestory/images/e/e1/Skill_Speed_Infusion.png/revision/latest?cb=20110508020039" alt="Skill Speed Infusion" width="32" height="32"/> <a href="https://maplestory.fandom.com/wiki/Speed_Infusion" target="_blank" rel="noreferrer noopener">Speed Infusion</a> provides another +2 AS, a Kaiser using <img src="https://vignette.wikia.nocookie.net/maplestory/images/4/4d/Skill_Dragon_Link.png/revision/latest?cb=20160609063015" alt="Skill Dragon Link" width="32" height="32"/> key-command skills when their Dragon Gauge is filled provides another +2 AS, etc.)</p>
            <p>As well, there are sources beyond your class's skills that you can obtain to further increase your Attack Speed (i.e. +1 AS Inner Ability +1 AS from <img src="https://vignette.wikia.nocookie.net/maplestory/images/e/e1/Skill_Speed_Infusion.png/revision/latest?cb=20110508020039" alt="Skill Speed Infusion" width="32" height="32"/> <a href="https://maplestory.fandom.com/wiki/Decent_Speed_Infusion" target="_blank" rel="noreferrer noopener">Decent Speed Infusion</a>, +1 AS from <img src="https://vignette.wikia.nocookie.net/maplestory/images/1/1e/Use_Extreme_Green_Potion.png/revision/latest?cb=20170206074332" alt="Use Extreme Green Potion" width="22" height="31"/> <a href="https://maplestory.fandom.com/wiki/Extreme_Green_Potion" target="_blank" rel="noreferrer noopener">Extreme Green Potion</a> from Monster Park, etc.)</p>
            ...
            <h3>Examples:</h3>
            <p>A Dark Knight wielding a <img src="https://maplestory.io/api/GMS/210.1.1/item/1432167/icon" alt=""/> Fafnir Brionak, which is Normal (6). The Dark Knight uses their <img src="https://vignette.wikia.nocookie.net/maplestory/images/a/a5/Skill_Weapon_Booster_%28Spearman%29.png/revision/latest?cb=20110420132354" alt="Skill Weapon Booster (Spearman)" width="32" height="32"/> Weapon Booster skill that gives +2 AS, plus he has <img src="https://vignette.wikia.nocookie.net/maplestory/images/e/e1/Skill_Speed_Infusion.png/revision/latest?cb=20110508020039" alt="Skill Speed Infusion" width="32" height="32"/> Decent Speed Infusion that gives +1 AS (for a total of +3 AS). Thus, their final attack speed is: Normal (6) - (+3 AS) = Faster (3)</p>
            <p>A Cannoneer with a <img src="https://maplestory.io/api/GMS/210.1.1/item/1532098/icon" alt=""/> Fafnir Lost Cannon, which is Slow (8). The Cannoneer gets +2 AS from their <img src="https://vignette.wikia.nocookie.net/maplestory/images/c/cd/Skill_Cannon_Booster.png/revision/latest?cb=20110605012635" alt="Skill Cannon Booster" width="32" height="32"/> Weapon Booster skill, +1 AS from the <img src="https://vignette.wikia.nocookie.net/maplestory/images/7/71/Skill_Reinforced_Cannon.png/revision/latest?cb=20110606022210" alt="Skill Reinforced Cannon" width="32" height="32"/> Reinforced Cannon skill, +1 AS from the <img src="https://vignette.wikia.nocookie.net/maplestory/images/7/76/Skill_Cannon_Overload.png/revision/latest?cb=20110608083829" alt="Skill Cannon Overload" width="32" height="32"/> Cannon Overload skill, +1 AS from the <img src="https://maplestory.io/api/GMS/210.1.1/item/2023126/icon" alt=""/> Extreme Green Potion (for a total of +5 AS). Thus, their final attack speed is: Slow (8) - (+5 AS) = Faster (3)</p>
            ...
            <ul>
                <li><img src="https://vignette.wikia.nocookie.net/maplestory/images/e/e1/Skill_Speed_Infusion.png/revision/latest?cb=20110508020039" alt="Skill Speed Infusion" data-image-key="Skill_Speed_Infusion.png" data-image-name="Skill Speed Infusion.png" width={32} height={32}/> <a href="https://maplestory.fandom.com/wiki/Decent_Speed_Infusion" target="_blank" rel="noopener noreferrer">Decent Speed Infusion</a></li>
                <li>+1 Attack Speed Inner Ability</li>
                <li>Almost all Weapon Booster skills from your class' skills</li>
            </ul>
            <h3>Example:</h3>
            <p>A Shadower with a <img src="https://maplestory.io/api/GMS/210.1.1/item/1332225/icon" alt=""/> Fafnir Damascus, which is Fast (4). The Shadower gets +2 AS from their <img src="https://vignette.wikia.nocookie.net/maplestory/images/6/6c/Skill_Dagger_Booster.png/revision/latest?cb=20110504071007" alt="Skill Dagger Booster" width="32" height="32"/> Weapon Booster skill. They also have +1 AS Inner Ability. You may think her final attack speed is Fastest (1), since Fast (4) - (+3 AS) = Fastest (1). However, their weapon boosting skill nor the +1 attack speed inner ability can break the soft speed cap of Fastest (2). Thus, they are stuck at Fastest (2) despite her inner ability</p>
            ...
            <ul>
                ...
                <li>Battle Mage's <img src="https://vignette.wikia.nocookie.net/maplestory/images/c/cc/Skill_Hasty_Aura.png/revision/latest?cb=20150312015436" alt="Skill Hasty Aura" width={32} height={32} /> <a href="https://maplestory.fandom.com/wiki/Hasty_Aura" target="_blank" rel="noopener noreferrer">Hasty Aura</a> (+2 attack speed)</li>
                <li>Zero's <img src="https://vignette.wikia.nocookie.net/maplestory/images/9/9c/Skill_Divine_Speed.png/revision/latest?cb=20140107015542" alt="Skill Divine Speed" width={32} height={32} /> <a href="https://maplestory.fandom.com/wiki/Divine_Speed" target="_blank" rel="noopener noreferrer">Divine Speed</a> (+1 attack speed)</li>
                <li>Kaiser's <img src="https://vignette.wikia.nocookie.net/maplestory/images/e/ef/Skill_Kaiser%27s_Majesty.png/revision/latest?cb=20121015212936" alt="Skill Kaiser's Majesty" width={32} height={32} /> <a href="https://maplestory.fandom.com/wiki/Kaiser's_Majesty" target="_blank" rel="noopener noreferrer">Kaiser's Majesty</a> (+1 attack speed)</li>
            </ul>
