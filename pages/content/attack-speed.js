...
function AttackSpeed() {
    return (
        <ContentPage>
            ...
            <h3>Examples:</h3>
            <p>A Dark Knight wielding a <img src="/images/equipment/fafnir-brionak.png" alt="Eqp Fafnir Brionak"/> Fafnir Brionak, which is Average (4). The Dark Knight uses their <img src="/class-icons/explorers/dark-knight/agile-arms.png" alt="Skill Agile Arms"/> Weapon Booster skill that gives +2 AS, plus they have <img src="/class-icons/common/speed-infusion.png" alt="Skill Speed Infusion"/> Decent Speed Infusion that gives +1 AS (for a total of +3 AS). Thus, their final attack speed is: Average (4) + (+3 AS) = Faster (7)</p>
