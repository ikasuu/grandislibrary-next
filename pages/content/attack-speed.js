...
function AttackSpeed() {
    return (
        <ContentPage>
            ...
            <p><strong>[Note]: </strong>All mages except Battle Mage are not affected by their weapon's Attack Speed. Instead, all attacks have a cast speed of Average (Stage 4) regardless of weapon which is still affected by Attack Speed</p>
            <VideoAd/>
