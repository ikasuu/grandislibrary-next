...
function AttackSpeed() {
    return (
        <ContentPage>
            ...
            <p><strong>[Note]: </strong>All mage classes are not affected by their weapon's Attack Speed. Instead, all skill casts use a cast speed of Average (Stage 4) regardless of weapon</p>
            <VideoAd/>
