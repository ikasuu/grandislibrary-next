...
function AttackSpeed() {
    return (
        <ContentPage>
            ...
            <p><strong>[Note]: </strong>Hurricane-type / Key-down skills like <img src="/class-icons/explorers/bowmaster/hurricane.png" alt="Skill Hurricane"/> <a href="https://maplestorywiki.net/w/Hurricane" target="_blank" rel="noreferrer noopener">Hurricane</a>, <img src="/class-icons/heroes/phantom/mille-aiguilles.png" alt="Skill Mille Aiguilles"/> <a href="https://maplestorywiki.net/w/Mille_Aiguilles" target="_blank" rel="noreferrer noopener">Mille Aiguilles</a>, <img src="/class-icons/heroes/mercedes/ishtars-ring.png" alt="Skill Ishtar's Ring"/> <a href="https://maplestorywiki.net/w/Ishtar's_Ring" target="_blank" rel="noreferrer noopener">Ishtar's Ring</a>, <img src="/class-icons/resistance/xenon/beam-dance.png" alt="Skill Beam Dance"/> <a href="https://maplestorywiki.net/w/Beam_Dance" target="_blank" rel="noreferrer noopener">Beam Dance</a>, or <img src="/class-icons/resistance/wild-hunter/wild-arrow-blast.png" alt="Skill Wild Arrow Blast"/> <a href="https://maplestorywiki.net/w/Wild_Arrow_Blast" target="_blank" rel="noreferrer noopener">Wild Arrow Blast</a> are not affected by Attack Speed</p>
            ...
            <p>A few classes have skills other than their typical weapon boosting skill that further that boosts their attack speed (i.e. Buccaneer or Thunder Breaker's <img src="/class-icons/common/speed-infusion.png" alt="Skill Speed Infusion"/> <a href="https://maplestorywiki.net/w/Speed_Infusion" target="_blank" rel="noreferrer noopener">Speed Infusion</a> provides another +2 AS, a Kaiser using <img src="/class-icons/nova/kaiser/dragon-link.png" alt="Skill Dragon Link"/> key-command skills when their Dragon Gauge is filled provides another +2 AS, etc.)</p>
            <p>As well, there are sources beyond your class's skills that you can obtain to further increase your Attack Speed (i.e. +1 AS Inner Ability +1 AS from <img src="/class-icons/common/speed-infusion.png" alt="Skill Speed Infusion"/> <a href="https://maplestorywiki.net/w/Decent_Speed_Infusion" target="_blank" rel="noreferrer noopener">Decent Speed Infusion</a>, +1 AS from <img src="/images/items/extreme-green-potion.png" alt="Use Extreme Green Potion"/> <a href="https://maplestorywiki.net/w/Extreme_Green_Potion" target="_blank" rel="noreferrer noopener">Extreme Green Potion</a> from Monster Park, etc.)</p>
            ...
            <h3>Examples:</h3>
            <p>A Dark Knight has a <img src="/images/equipment/fafnir-brionak.png" alt="Eqp Fafnir Brionak"/> Fafnir Brionak equipped which is Average (4). The Dark Knight gets +2 AS from <img src="/class-icons/explorers/dark-knight/agile-arms.png" alt="Skill Agile Arms"/> Agile Arms, +1 AS from <img src="/class-icons/common/speed-infusion.png" alt="Skill Speed Infusion"/> Decent Speed Infusion, +1 AS from <img src="http://localhost:3000/class-icons/explorers/dark-knight/weapon-mastery.png" alt="Skill Weapon Mastery"/> Weapon Mastery when a Spear is equipped (for a total of +4 AS). Thus, their final attack speed is: Average (4) + (+4 AS) = Fastest (8)</p>
            <p>A Cannoneer has a <img src="/images/equipment/fafnir-lost-cannon.png" alt="Eqp Fafnir Lost Cannon"/> Fafnir Lost Cannon equipped which is Slow (2). The Cannoneer gets +2 AS from <img src="/class-icons/explorers/cannoneer/agile-cannons.png" alt="Skill Agile Cannons"/> Agile Cannons, +1 AS from the <img src="/class-icons/explorers/cannoneer/reinforced-cannon.png" alt="Skill Reinforced Cannon"/> Reinforced Cannon, +1 AS from <img src="/class-icons/explorers/cannoneer/cannon-overload.png" alt="Skill Cannon Overload"/> Cannon Overload, +1 AS from <img src="http://localhost:3000/class-icons/explorers/cannoneer/buckshot.png" alt="Skill Buckshot"/> Buckshot (for a total of +5 AS). Thus, their final attack speed is: Slow (2) + (+5 AS) = Faster (7)</p>
            ...
            <ul>
                <li><img src="/class-icons/common/speed-infusion.png" alt="Skill Speed Infusion" data-image-key="Skill_Speed_Infusion.png" data-image-name="Skill Speed Infusion.png"/> <a href="https://maplestorywiki.net/w/Decent_Speed_Infusion" target="_blank" rel="noopener noreferrer">Decent Speed Infusion</a></li>
            ...
            <ul>
                ...
                <li>Cannoneer's <img src="http://localhost:3000/class-icons/explorers/cannoneer/buckshot.png" alt="Skill Buckshot"/> <a href="https://maplestorywiki.net/w/Buckshot" target="_blank" rel="noopener noreferrer">Buckshot</a> (+1 AS)</li>
