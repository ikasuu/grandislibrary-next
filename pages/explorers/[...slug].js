...
function ClassOverview({post, slug}) {
    ...
    return (
        <div>
            ...
            <Container>
            <Alert variant="warning">[Note] Class Overviews are slowly being updated with Destiny update changes. Please check <a href="https://discord.gg/d4et8vt9kP" target="_blank" rel="noreferrer noopener">Discord</a> server for updates</Alert>
