...
function MaplehoodWatch() {
    return (
        <EventPage>
            ...
            <p><img src="https://i.imgur.com/XrniZ7V.png" alt="Maplehood Watch Schedule 2019"/></p>
            ...
            <img className="repository-image" src="http://nxcache.nexon.net/cms/2017/2937/6sahdeg43t.jpg" alt="Maplehood Watch Event"/>
            <h2>Beauty Day</h2>
            ...
            <p><img className="repository-image" src="http://nxcache.nexon.net/cms/2019/Q3/2224/female-hairs.png" alt="Female Hairstyles"/></p>
            <p>Female: Ballroom Classic, Cute Tied Bun Hair, Eve Hair, Lively Braided Hair, Spiral Curl Hair, and Wild Child Tied Hair</p>
            <p><img className="repository-image" src="http://nxcache.nexon.net/cms/2019/Q3/2226/male-faces.png" alt="Male Facestyles"/></p>
            <p>Male: Arrogant Face, Clear Face, Dewy-Eyed Face, Friendly Friend Face, Overjoyed Smile, and Piercing Gaze</p>
            <p><img className="repository-image" src="http://nxcache.nexon.net/umbraco/6377/fflak35.jpg" alt="Female Facestyles"/></p>
            ...
            <p><img className="repository-image" src="http://nxcache.nexon.net/umbraco/9944/g2mak67.jpg" alt="Maplehood Gacha Items p2"/></p>
            <p>Lv. 150 Fafnir set equips/weapons and Lv. 140 Empress set equips/weapons</p>
            <p><img className="repository-image" src="http://nxcache.nexon.net/cms/2019/Q3/2291/new-gacha-chairs.png" alt="Maplehood Gacha Chairs"/></p>
            ...
            <p><img className="repository-image" src="http://nxcache.nexon.net/umbraco/9947/g4man12.jpg" alt="Maplehood Gacha Androids"/></p>
            ...
            <p><img className="repository-image" src="http://nxcache.nexon.net/cms/2019/Q3/2228/pssb-1.png" alt="Maplehood Avatar Items"/></p>
            ...
            <p><img className="repository-image" src="http://nxcache.nexon.net/cms/2019/Q3/2229/pssb-2.png" alt="Maplehood Avatar Items p2"/></p>
            ...
            <p><img className="repository-image" src="http://nxcache.nexon.net/cms/2019/Q3/2230/pssb-3.png" alt="Maplehood Avatar Items p3"/></p>
            <hr/>
            <h3>Credits:</h3>
